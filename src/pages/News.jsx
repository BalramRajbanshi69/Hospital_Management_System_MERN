...
import NewsPic from "../../src/assets/servicesecond.jpg";
import Blog1 from "../../src/assets/about-us-intro-2.jpg";
import Blog2 from "../../src/assets/blog31.jpg";
    ...
    <div>
      ...
      <div
        ...
        style={{
          ...
          backgroundPosition: "center 20%", // Adjusts vertical position
      ...
      <div className="mx-4 px-5 sm:mx-6 lg:mx-24 md:mx-12 xl:mx-48">
        <div className="flex flex-col lg:flex-row my-8 sm:my-12 lg:my-16 gap-5">
          ...
          <div className="flex flex-col  gap-8">
            ...
            <div className="h-[664px] flex flex-col gap-4">
              <div
                className="w-full lg:w-[658px] h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] bg-cover bg-top bg-no-repeat"
                style={{
              ...
              <div>
                <p className="post-paragraph -tracking-wider">
                  A passion for putting patients first
                </p>
              </div>

              <div className="max-w-[590px]">
                <p className="text-[#212124]">
              ...
              <div className="w-[155px] mt-2">
                ...
                >
                  ...
                  <span className="ml-2">
                    {" "}
                    <FaArrowRight className="w-3 h-3 text-[#1F2B6C] mt-1" />{" "}
                  </span>
                </Link>
              </div>
            </div>

            {/* first column second blog2 */}
            <div className="h-[664px] flex flex-col gap-4">
              <div
                className="w-full lg:w-[658px] h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] bg-cover bg-top bg-no-repeat"
                style={{
            ...
            <div className="flex flex-col sm:flex-row justify-between  items-center gap-4 sm:gap-0  ">
              <button className="flex gap-2 items-center opacity-40 ">
                <FaArrowLeft size={14} className="text-[#1F2B6C]" />
                <span className="text-[#159EEC] text-sm sm:text-base">
                  Previous Page
                </span>
              </button>

              <div className="flex items-center gap-2 text-sm sm:text-base">
                <span className="text-[#1F2B6C] font-medium">1</span>
                {[2, 3, 4, 5].map((num) => (
                  <React.Fragment key={num}>
                    <span>-</span>
                    <span className="text-[#159EEC] font-medium">{num}</span>
                  </React.Fragment>
                ))}
              </div>

              <Link to="/news/healthcare" className="flex gap-2 items-center">
                <span className="text-[#159EEC] text-sm sm:text-base">
                  Next Page
                </span>
                <FaArrowRight size={14} className="text-[#1F2B6C]" />
              </Link>
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1  ">
            ...
            <div className="mt-8 border-gray-200 shadow-gray-900 border-2 rounded-md p-4">
              ...
              <div className="mt-4 sm:mt-6 flex flex-col gap-4 p-6">
                {[
