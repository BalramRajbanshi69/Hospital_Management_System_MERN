...
import SecondPicTwo from "../../src/assets/secondpictwo.jpg";
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${SecondPicTwo})`,
        }}
      >
      ...
      {/* news */}
      <div className=" mx-4  sm:mx-6 lg:mx-24 md:mx-12 xl:mx-48 my-16 px-5">
